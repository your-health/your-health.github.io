...
from ._anvil_designer import AllergiesRowTemplate
from anvil import *
import anvil.server
...
class AllergiesRow(AllergiesRowTemplate):
  """
  View/Edit a single row of Allergies.repeating_panel.items.

  Notes
  ------
  1. See Allergies for details of format of self.items
  ...
  def set_panel_visibility(self):
    ...
    self.description_view_row_panel.visible = view_visable
    self.note_view_row_panel.visible = view_visable

    self.name_edit_row_panel.visible = edit_visable
    self.description_edit_row_panel.visible = edit_visable
  ...
  def edit_button_click(self, **event_args):
    ...
    self.description_edit_textbox.text = self.item['description']
  ...
  def delete_button_click(self, **event_args):
    ...
    reply = confirm(f"Are you sure you want to delete this allergy?")
    if reply:
